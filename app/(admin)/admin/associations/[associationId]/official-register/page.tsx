...
import OfficialRegisterClient from "@/components/admin/associations/OfficialRegisterClient";
  ...
  return (
    <div className="p-6 space-y-6">
      <div className="flex flex-wrap items-center gap-2 text-sm">
        ...
        <span className="text-slate-400">/</span>
        <span className="font-bold text-[#06054e]">Official register</span>
      </div>
      ...
      <h1 className="text-2xl font-black text-[#06054e]">Official register (F1)</h1>

      <OfficialRegisterClient
...
export async function generateMetadata({
  ...
  const { associationId } = await params;
  return { title: `Official register | ${associationId} | Admin` };
}
