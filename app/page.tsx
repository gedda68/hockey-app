// app/page.tsx
// Main home page with news sidebar
...
import { NewsItem, getActiveNews } from "@/types/news";
...
export default async function HomePage() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-[#06054e] via-slate-900 to-slate-800 flex">
      {/* News Sidebar - Left */}
      {newsItems.length > 0 && <NewsSidebar newsItems={newsItems} />}
        ...
        <div className="max-w-7xl mx-auto px-6 py-20">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-slate-300 font-bold max-w-2xl mx-auto mb-8">
              Complete management system for hockey associations, clubs,
              players, and staff. Streamline your operations with powerful
              tools.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mt-20">
            ...
            <div className="bg-white/10 backdrop-blur-sm border border-white/20 rounded-[2rem] p-8 hover:bg-white/15 transition-all">
              ...
              <p className="text-slate-300 font-bold">
                Comprehensive reporting, statistics, financial tracking, and
                data export.
              </p>
            </div>
          ...
          <div className="mt-20 text-center">
            <div className="bg-white/10 backdrop-blur-sm border border-white/20 rounded-[2rem] p-12">
              ...
              <p className="text-lg text-slate-300 font-bold mb-8 max-w-2xl mx-auto">
                Access the admin portal to manage your hockey organization.
          ...
          <div className="max-w-7xl mx-auto px-6 py-8">
            <div className="text-center">
              <p className="text-slate-400 font-bold">
                © {new Date().getFullYear()} Sports Solutions. All rights
                reserved.
              </p>
