...
| **Fixture schedule / venue change** | League fixture PATCH: `notifyScheduleChange: true` with `scheduleChangeNotifyEmails: [...]` (1–10). Sends only if the fixture is **published** after the patch and **time, venue, or address** changed. |
